...
Homem.prototype = { 
   atualizar: function() { 
      if (this.teclado.pressionada(SETA_DIREITA)) {
         ...
         if (! this.andando || this.direcao != Homem_DIREITA) {
         ...
         if (! this.andando || this.direcao != Homem_ESQUERDA) {
            this.sheet.linha = 1; 
            this.sheet.coluna = 0;
         }
         ...
         if (! this.andando || this.direcao != Homem_CIMA) {
            this.sheet.linha = 3; 
            this.sheet.coluna = 0;
         }
         this.andando = true;
         ...
         if (! this.andando || this.direcao != Homem_BAIXO) {
            this.sheet.linha = 0; 
            this.sheet.coluna = 0;
         }
         this.andando = true;
         ...
         if (this.direcao == Homem_DIREITA) 
            this.sheet.coluna = 0; 
         else if (this.direcao == Homem_ESQUERDA) 
            this.sheet.coluna = 1; 
